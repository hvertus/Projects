        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Book Tagged<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="tag?option=tag">Add tag</a></li>
                          <li class="divider"></li>                        
                          <li><a href="tag?option=tagBook">Add tag to a book</a></li>
                          <li><a href="BookTagged">Tags' book</a></li>
                          <li><a href="bookTag">Books' tag</a></li>
                        </ul>
                    </li>                          
                </ul>
            </div>
